...
public class Level05_AssembledSequenceStepper : SequenceStepper
{
    ...
    {
        GameplayEventBus.Instance.Unsubscribe<GameplayEvents.AssemblySpawnedItem>(OnAssemblySpawnedItem);
