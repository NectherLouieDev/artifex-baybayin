...
public class Level04_FryerSequenceStepper : SequenceStepper
{
    ...
    private void Start()
    {
        GameplayEventBus.Instance.Subscribe<GameplayEvents.FryerSpawnedItem>(OnFryerSpawnedItem);
    ...
    private void OnFryerSpawnedItem(GameplayEvents.FryerSpawnedItem evt)
    {
        GameplayEventBus.Instance.Unsubscribe<GameplayEvents.FryerSpawnedItem>(OnFryerSpawnedItem);
