...
public class Level07_ChopperSequenceStepper : SequenceStepper
{
    ...
    private void Start()
    {
        GameplayEventBus.Instance.Subscribe<GameplayEvents.ChopperSpawnedItem>(OnChopperSpawnedItem);
    ...
    private void OnChopperSpawnedItem(GameplayEvents.ChopperSpawnedItem evt)
    {
        GameplayEventBus.Instance.Unsubscribe<GameplayEvents.ChopperSpawnedItem>(OnChopperSpawnedItem);
