...
public class Level07_OvenSequenceStepper : SequenceStepper
{
    ...
    private void Start()
    {
        GameplayEventBus.Instance.Subscribe<GameplayEvents.OvenSpawnedItem>(OnOvenSpawnedItem);
    ...
    private void OnOvenSpawnedItem(GameplayEvents.OvenSpawnedItem evt)
    {
        GameplayEventBus.Instance.Unsubscribe<GameplayEvents.OvenSpawnedItem>(OnOvenSpawnedItem);
