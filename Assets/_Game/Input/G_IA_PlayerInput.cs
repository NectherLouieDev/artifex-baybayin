...
//     version 1.18.0
//     from Assets/_Game/Input/G_IA_PlayerInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/_Game/Input/G_IA_PlayerInput.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @G_IA_PlayerInput: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @G_IA_PlayerInput()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""G_IA_PlayerInput"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@G_IA_PlayerInput()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, G_IA_PlayerInput.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, G_IA_PlayerInput.UI.Disable() has not been called.");
    }
    ...
    {
        private @G_IA_PlayerInput m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@G_IA_PlayerInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@G_IA_PlayerInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
